...
function extractFrontmatter(content) {
  ...
  // Parse YAML frontmatter only from the start of the file.
  // Many plan docs use later `---` separators for markdown sections, and treating
  // those as additional frontmatter blocks causes false validation warnings.
