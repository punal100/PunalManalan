...
Intel system is disabled. To activate:
  ...
  node .github/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node .github/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node .github/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node .github/get-shit-done/bin/gsd-tools.cjs intel diff
```
